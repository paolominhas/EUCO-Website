...
const Performances = () => {
  return (
    <>
        <title>Upcoming Concerts | Edinburgh University Chamber Orchestra</title>
          ...
          <div>
            ...
            <div className="space-y-6">
              {upcomingConcertsData.map(concert => (
                <div key={concert.date} className="bg-gray-800 p-6 rounded-lg shadow-lg border-l-4 border-blue-600">
                  <p className="font-bold text-lg">{concert.date} - {concert.time}</p>
                  <p className="text-blue-400">{concert.venue}</p>
                  ...
                  {concert.tickets && (
                    <a 
                      ...
                      className="inline-flex items-center mt-4 px-4 py-2 bg-blue-600 text-black font-semibold rounded-md hover:bg-blue-500 transition-colors"
                    >
