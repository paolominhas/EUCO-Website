...
import { ReactComponent as UoELogo } from '../logos/UoE-logo.svg'; // Note the '../' to go up one directory level
    ...
    <footer className="bg-black mt-16 py-8">
      <div className="container mx-auto px-6 text-center text-gray-400">
        <div className="flex justify-center items-center space-x-6 mb-4">
          ...
          {/* External link to the University of Edinburgh website */}
          <a 
        ...
        {/* The copyright notice with a dynamic year */}
